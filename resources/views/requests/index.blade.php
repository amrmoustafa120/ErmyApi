											...
											<div class="table-responsive">
												<table class="table table-striped table-bordered mb-0 text-nowrap">
													...
													<tr>
														...
														{{-- <td>{{$request->states_id->id}}</a></td> --}}
														<td>{{$request->created_at}}</td>
														<td>
                                                        <a href="/edit/request/{{$request->id}}" class="btn btn-action btn-primary">edit</a>
                                                        
														 <form action="{{action('RequestsController@destroy', $request->id)}}" method="post">
														{{csrf_field()}}
